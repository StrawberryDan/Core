...
namespace Strawberry::Core::Math
{
    ...
    public:
        AABB(VectorType position, VectorType extent);
              ...
              VectorType& Position()       { return mPosition; }
        const VectorType& Position() const { return mPosition; }
              VectorType&   Extent()       { return mExtent; }
        const VectorType&   Extent() const { return mExtent; }
        ...
        T Area()   const requires (D == 2) { return Mensuration(); }
        T Volume() const requires (D == 3) { return Mensuration(); }
