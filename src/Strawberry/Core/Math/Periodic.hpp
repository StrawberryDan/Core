...
namespace Strawberry::Core::Math
{
    ...
    class DynamicPeriodic<T>
    {
        public:
            ...
            auto operator<=>(const DynamicPeriodic& rhs) const
            {
                return mValue <=> rhs.mValue;
            }


            bool operator==(const DynamicPeriodic& rhs) const
            {
                return mValue == rhs.mValue;
            }
            ...
            DynamicPeriodic operator-(DynamicPeriodic rhs) const
            {
                return rhs.mValue >= mValue
                       ? DynamicPeriodic(mMax, (mMax - (rhs.mValue - mValue)) % mMax)
            ...
            void operator+=(DynamicPeriodic rhs)
            {
                *this = *this + rhs;
            }
