...
namespace Strawberry::Core
{
    ...
    Optional<std::u8string> ToUTF8(char32_t utf32)
    {
        ...
        switch (utf8Len)
        {
            case 1: finalByte = 0b00000000 | (utf32 >> shift);
                break;
            case 2: finalByte = 0b11000000 | (utf32 >> shift);
                break;
            case 3: finalByte = 0b11100000 | (utf32 >> shift);
                break;
            case 4: finalByte = 0b11110000 | (utf32 >> shift);
            default: Unreachable();
        }
