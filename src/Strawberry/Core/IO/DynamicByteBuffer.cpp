...
Strawberry::Core::Optional<Strawberry::Core::IO::DynamicByteBuffer> Strawberry::Core::IO::DynamicByteBuffer::FromFile(const std::filesystem::path& path)
{
...
Strawberry::Core::Result<size_t, Strawberry::Core::IO::Error> Strawberry::Core::IO::DynamicByteBuffer::Write(
    const Strawberry::Core::IO::DynamicByteBuffer& bytes)
{
    for (auto byte: bytes)
    {
        Push(byte);
